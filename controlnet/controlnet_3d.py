...
from ldm.modules.diffusionmodules.util import PseudoConv3d
...
class ControlNetModel3D(ModelMixin, ConfigMixin):
    ...
    def from_2d_model(cls, model_path):
        ...
        if "global_pool_conditions" in config:
            if config["global_pool_conditions"] is False:
                config.pop("global_pool_conditions")
            else:
